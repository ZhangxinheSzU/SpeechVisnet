...
from src.models.models_speech import SQLDecoder_LSTM, audioModel, textModel
...
class SpeechSQLNet(nn.Module):
    def __init__(self,type, grammar,LSTM_num_layers,s2vec,t2vec,use_gcn = False, model_sw = None):
        ...
        self.decoder = SQLDecoder_LSTM.SQLDecoder(self.grammar, LSTM_num_layers)
