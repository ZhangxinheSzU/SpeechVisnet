...
from src.models.models_speech import SQLDecoder_copy, audioModel, textModel
...
class SpeechSQLNet(nn.Module):
    def __init__(self,type, grammar,s2vec,t2vec,use_gcn = False, model_sw = None):
        ...
        self.decoder = SQLDecoder_copy.SQLDecoder(self.grammar)
