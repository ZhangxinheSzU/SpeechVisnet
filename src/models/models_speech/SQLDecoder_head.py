...
from src.models.common_modules import nn_utils, pointer_net_head

from src.config import cfg

class SQLDecoder(nn.Module):
    def __init__(self, grammar,heads):
        ...
        self.column_pointer_net = pointer_net_head.MultiHeadPointerNet(args.DECODER.hidden_size, args.DECODER.col_embed_size, self.heads,attention_type=args.DECODER.column_att)
        self.table_pointer_net = pointer_net_head.MultiHeadPointerNet(args.DECODER.hidden_size, args.DECODER.col_embed_size,self.heads, attention_type=args.DECODER.column_att)
