...
class Example:
    """
        class for data unit
    """
    def __init__(self, src_speech, sql=None, table_names=None, table_len=None, tab_cols = None,
                 col_table_dict=None, cols=None, schema_seqs = None,graph = None,tgt_actions=None,
        ):

        self.src_speech = src_speech
        self.src_speech_len = sum(self.src_speech[0] != 0)
        self.sql = sql
...
class Batch(object):
    '''
        batch for examples
    '''
    def __init__(self, examples, grammar, word_emb, cuda=False, word_encoder = None):
        ...
        # speech
        src_speeches = [torch.tensor(e.src_speech) for e in self.examples]
        ...
        self.src_speeches = src_speeches
