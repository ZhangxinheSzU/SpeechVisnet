...
class SpeechSQLDataset(Dataset, SpectrogramParser):
    def __init__(self,type, sql_path, speech_path, table_path, normalize=False, augment=False, ifeval = False, if_parse_audio = True, mode = 'train',processor=None):
        ...
        self.dev_speech_path = '/home/zhoujh/wav/else/'
        self.train_speech_path = '/home/zhoujh/wav/train/'
    ...
    def __getitem__(self, index):
        ...
        id1 = sql_data['id1']
        id2 = sql_data['id2']
        tts_filename = f'{id1}_{id2}_result'
        if self.mode =='train':
            
            
            wav_path = '/home/zhoujh/wav/train/{}.wav'.format(tts_filename)
        else:
            wav_path ='/home/zhoujh/wav/else/{}.wav'.format(tts_filename)
